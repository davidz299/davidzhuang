...
export async function getStaticProps() {
  const meta = {
    title: 'Contact // Chen (David) Zhuang',
    tagline: 'Contact me at any time!',
...
function Contact(props) {
  ...
  const description = `<strong>I'm always open to chatting </strong> with new people. <strong>Feel free to contact me at any time</strong>, and I will respond as soon as possible!`
  ...
  return (
    <>
      <Head>
        ...
        <meta content="https://chendavidzhuang.com/contact" property="og:url" />
      ...
      <Box>
        ...
        <Form onSubmit={onSendEmail}>
          ...
          <FormGroup>
            ...
            <Textarea id="message" placeholder="Send a message" rows="4" required />
          </FormGroup>
          <FormGroup>
